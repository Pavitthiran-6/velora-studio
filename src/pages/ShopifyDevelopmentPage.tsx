...
const PROJECTS = [
  { name: "VALACLAVA", category: "SHOPIFY / E-COMM", id: "01", img: valaclavaImg },
  { name: "OCEAN AGENCY", category: "SHOPIFY / UX", id: "02", img: oceanImg },
  { name: "HOBOKEN YOGI", category: "SHOPIFY / DESIGN", id: "03", img: yogiImg },
];
    ...
    <section className="h-full relative flex flex-col pt-16 md:pt-20 pb-8 overflow-hidden justify-center">
      <Layout>
        ...
        <div className="flex flex-col mb-6 md:mb-10">
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-[#ef3b5d]" intensity={1.2}>SHOPIFY</CinematicText>
