...
const PROJECTS = [
  { name: "VALACLAVA", category: "WEB DESIGN / 3D", id: "01", img: valaclavaImg },
  { name: "OCEAN AGENCY", category: "WEB DESIGN / WEBGL", id: "02", img: oceanImg },
  { name: "HOBOKEN YOGI", category: "WEB DESIGN / E-COMM", id: "03", img: yogiImg },
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#ef3b5d" />
                    <CinematicText className="text-[10px] font-black tracking-[0.3em] uppercase text-[#ef3b5d]">WEBSITE DESIGN</CinematicText>
                  </div>
                </div>
    ...
    <section className="h-full relative flex flex-col pt-16 md:pt-20 pb-8 overflow-hidden justify-center">
      <Layout>
        ...
        <div className="flex flex-col mb-6 md:mb-10">
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-[#ef3b5d]" intensity={1.2}>
            WEBSITE
          </CinematicText>
      ...
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        ...
        >
          <div className="relative">
            ...
            >
              <h2 className="text-[20vw] font-display font-black uppercase tracking-[-0.04em] text-[#ef3b5d] leading-none text-center whitespace-nowrap">
                {"PROCESS".split("").map((char, i) => (
                  <WaveLetter key={i} char={char} index={i} progress={smoothProgress} />
                ))}
              </h2>
...
function ProcessCard({ step, index }: { step: any; index: number }) {
  ...
  return (
    <div
      className={cn(
        "flex-shrink-0 w-[85vw] md:w-[450px] min-h-[400px] md:h-[550px] group relative bg-[#1a1f3d] p-10 md:p-16 rounded-[32px] border border-white/10 hover:border-white/20 transition-all duration-500 hover:shadow-[0_40px_80px_rgba(0,0,0,0.5)] flex flex-col",
        shiftClass
      )}
    >
      <div className="flex flex-col h-full">
        ...
        <h3 className="text-4xl md:text-6xl font-display font-black tracking-[-0.04em] uppercase leading-none mb-8 group-hover:text-[#ef3b5d] transition-colors text-white">
          {step.title}
        </h3>
        ...
        <div className="mt-auto flex justify-between items-center">
          <HexIcon className="w-6 h-6 opacity-40 group-hover:opacity-100 transition-opacity" fill="#ef3b5d" />
        </div>
      </div>
    </div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-40 h-fit space-y-6">
            ...
            <CinematicText as="h2" className="text-6xl md:text-8xl font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-white">
              LATEST<br />
              <span className="text-[#ef3b5d]">PROJECTS<span className="text-white">.</span></span>
            </CinematicText>
          </div>
          ...
          >
            ...
            <div className="w-12 h-[1px] bg-white/20 relative overflow-hidden">
              <motion.div
                ...
                className="absolute inset-0 bg-[#ef3b5d]"
              />
            </div>
          </motion.button>
        </div>
      ...
      <div className="aspect-[4/5] rounded-[32px] overflow-hidden mb-8 relative">
        ...
        <div className="absolute bottom-10 left-10 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
          ...
          <div className="relative inline-block">
            ...
            <div className="absolute -bottom-1 left-0 w-full h-[2px] bg-[#ef3b5d] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
          </div>
