...
const PROJECTS = [
  { name: "VALACLAVA", category: "SEO / STRATEGY", id: "01", img: valaclavaImg },
  { name: "OCEAN AGENCY", category: "SEO / AUDIT", id: "02", img: oceanImg },
  { name: "HOBOKEN YOGI", category: "SEO / E-COMM", id: "03", img: yogiImg },
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#ef3b5d" />
                    <CinematicText className="text-[10px] font-black tracking-[0.3em] uppercase text-[#ef3b5d]">SEO</CinematicText>
                  </div>
                </div>
        ...
        <div className="mt-32 flex justify-center">
          <motion.button whileHover={{ y: -5 }} className="group flex flex-col items-center gap-4">
            ...
            <div className="w-12 h-[1px] bg-white/20 relative overflow-hidden">
              <motion.div initial={{ x: "-100%" }} whileHover={{ x: "100%" }} transition={{ duration: 0.6, ease: "easeInOut" }} className="absolute inset-0 bg-[#ef3b5d]" />
            </div>
          </motion.button>
        </div>
      </Layout>
