      ...
      <Layout className="flex-1 flex flex-col justify-center">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <h1 className="text-[12vw] font-black tracking-tighter uppercase leading-none mb-8">
            WORK<span className="text-[#ef4444]">.</span>
          </h1>
          <p className="text-white/40 text-sm font-black tracking-[0.2em] uppercase max-w-lg">
            Our portfolio of high-impact digital experiences — coming soon.
          </p>
        </motion.div>
      </Layout>
    </div>
