          ...
          >
            <div className="w-full max-w-sm space-y-8 text-center">
              ...
              <div className="space-y-3">
                <p className="text-[10px] font-black tracking-[0.6em] uppercase opacity-40">Communication Bridge</p>
                <h2 className="text-4xl font-display font-black tracking-tighter uppercase">SYNCING INBOX...</h2>
              </div>
